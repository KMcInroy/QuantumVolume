...
If[Length[GateQubits]==2,CZCount+=1;If[GateQubits[[1]]<=(userconfig[NQubits]-1)-6*(ZonesMoved+1),MoveSize=((userconfig[NQubits]-1)-Ceiling[GateQubits[[1]],6])/2;ZonesMoved+=MoveSize/3;{Subscript[Wait, 0][40],Subscript[CZPI,GateQubits[[1]],GateQubits[[2]]]},Subscript[CZPI,GateQubits[[1]],GateQubits[[2]]]],Subscript[ToExpression[GateName], GateQubits[[1]]][GateParameters]],{j,1,DataSet[[i,1]]}]]];
